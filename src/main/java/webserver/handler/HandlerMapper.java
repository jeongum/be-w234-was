...
import webserver.handler.memo.MemoCreateHandler;
...
public class HandlerMapper {
    ...
    public HandlerMapper() {
        ...
        handlerMap.put("/memo/list", new MemoListHandler()); // 메모 목록
        handlerMap.put("/memo/create", new MemoCreateHandler()); // 메모 작성
    }
